...
ParticleData::ParticleData( NxParticleData data )
{
	...
	*_data = data;
	...
	if( _data->numParticlesPtr != NULL )
	{
		...
		_data->numParticlesPtr = new NxU32();
		*_data->numParticlesPtr = *data.numParticlesPtr;
...
int ParticleData::NumberOfParticles::get()
{
	return *_data->numParticlesPtr;
}
void ParticleData::NumberOfParticles::set( int value )
{
	(*_data->numParticlesPtr) = value;
}
