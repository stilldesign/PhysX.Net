...
JointLimit^ D6Joint::LinearLimit::get()
{
	return JointLimit::ToManaged(&this->UnmanagedPointer->getLinearLimit());
}
void D6Joint::LinearLimit::set(JointLimit^ value)
{
	this->UnmanagedPointer->setLinearLimit(JointLimit::ToUnmanaged(value));
}

JointLimitPair^ D6Joint::TwistLimit::get()
{
	return JointLimitPair::ToManaged(&this->UnmanagedPointer->getTwistLimit());
}
void D6Joint::TwistLimit::set(JointLimitPair^ value)
{
	this->UnmanagedPointer->setTwistLimit(JointLimitPair::ToUnmanaged(value));
}
