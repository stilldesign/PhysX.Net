...
namespace PhysX
{
	...
	public enum class ParticleBaseFlag
	{
		...
		/// <summary>
		/// Enable/disable particle indices debug mode.
		/// This can be used to help finding erroneous and unintended particle updates.
		/// Note that any operations on invalid particles have undefined effects. Warnings are issued in
		/// checked builds. However, particle indices get reused when releasing and creating new particles.
		/// Under these circumstances erroneous particle updates might pass undetected.
		/// Switching on this flag and setting ParticleBaseDesc.MaxParticles to a large value might help to debug bad index management.
		/// </summary>
		MinimizeIndexReuseDebugMode = PxParticleBaseFlag::eMINIMIZE_INDEX_REUSE_DEBUG_MODE,
