...
ControllerState^ ControllerState::ToManaged(PxControllerState unmanaged)
{
	...
	managed->TouchedShape = ObjectTable::GetObject<Shape^>((intptr_t)unmanaged.touchedShape);
	managed->TouchedActor = ObjectTable::GetObject<RigidActor^>((intptr_t)unmanaged.touchedActor);
