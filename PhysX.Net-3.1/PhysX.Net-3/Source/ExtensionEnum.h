...
namespace PhysX
{
	...
	/// </summary>
	public enum class RemoteDebuggerConnectionFlags
	{
		Unknown = PxExtensionConnectionType::Unknown,
		...
		/// </summary>
		Debug = PxExtensionConnectionType::Debug,
		...
		/// </summary>
		Profile = PxExtensionConnectionType::Profile,
		...
		/// </summary>
		Memory = PxExtensionConnectionType::Memory
	};
};