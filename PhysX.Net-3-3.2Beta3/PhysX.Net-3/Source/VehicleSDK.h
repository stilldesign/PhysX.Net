...
namespace PhysX
{
	...
	public:
		...
		/// </summary>
		void Vehicle4WEnable3WDeltaMode(VehicleWheelsSimData^ suspensionWheelTireData, VehicleDriveSimData4W^ coreData);
		...
		void Vehicle4WEnable3WTadpoleMode(VehicleWheelsSimData^ suspWheelTireData, VehicleDriveSimData4W^ coreData);
