...
namespace PhysX
{
	namespace VisualDebugger
	{
		...
		{
			Unknown = PxVisualDebuggerConnectionFlag::Unknown,
			...
			/// </summary>
			Debug = PxVisualDebuggerConnectionFlag::Debug,
			...
			/// </summary>
			Profile = PxVisualDebuggerConnectionFlag::Profile,
			...
			/// </summary>
			Memory = PxVisualDebuggerConnectionFlag::Memory
		};
	};
};